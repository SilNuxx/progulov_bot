...
- [ ] - Нужно либо научить пользователя писать цифры вместо причины, либо конвертировать второе в первое перед записью в БД
...
- [ ] - Переписать таблицу для отображения причины в виде числа (уваж - 0, по болезни - 1, неуваж - 2)
